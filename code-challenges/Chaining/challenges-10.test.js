...
//The idea is to put all the arrays in one array to loop through it and check
//for all values inside the arr if the target equal one of them then create arr and put it inside it then return the length
const count = (target, input) => {
  const myArr = input.reduce((acc, val) => {
...
//The same as the previouse challenge but here I want to calculate the total sum for my arr
